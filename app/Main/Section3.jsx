  ...
  return (
    <section className="section three">
      <div className="three-content">
        <h1 className="subheadline white" ref={textRef} >We don’t just create campaigns, we <span className="blue" > ignite <br /> movements</span>. <Image src="/images/heavetest.png" className="three-image three-image-1" ref={imageRef1} width={500} height={500} alt="alt" /> Leveraging our <span className="blue" >vast network</span> <Image src="/images/heavetest2.png" className="three-image three-image-2" ref={imageRef2} width={500} height={500} alt="alt" /> of influencers and digital platforms, we elevate your brand from concept to<span className="blue" > viral success</span>, <Image src="/images/heavetest3.png" className="three-image three-image-3" ref={imageRef3} width={500} height={500} alt="alt" /> keeping your audience captivated and engaged.</h1>
      </div>
