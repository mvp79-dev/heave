  ...
  return (
    <section className="section three">
      <div className="three-content">
        <h1 className="subheadline three-subheadline white" ref={textRef} >We don’t just create campaigns, we <span className="blue" > ignite {!isMobile && <br />} movements</span>. <img src="https://cdn.glitch.global/fb77b0c4-3062-4970-a03b-49138657d8c7/heavelogo3.webp?v=1730998907669" width={500} height={500} className="three-image three-image-1" ref={imageRef1} alt="alt" /> Leveraging our <span className="blue" >vast network</span> <img src="https://cdn.glitch.global/fb77b0c4-3062-4970-a03b-49138657d8c7/heavelogo2.webp?v=1730998909994" width={500} height={500} className="three-image three-image-2" ref={imageRef2} alt="alt" /> of influencers and digital platforms, we elevate your brand from concept to<span className="blue" > viral success</span>, <img src="https://cdn.glitch.global/fb77b0c4-3062-4970-a03b-49138657d8c7/heavelogo1.webp?v=1730998912628" width={500} height={500} className="three-image three-image-3" ref={imageRef3} alt="alt" /> keeping your audience captivated and engaged.</h1>
      </div>
